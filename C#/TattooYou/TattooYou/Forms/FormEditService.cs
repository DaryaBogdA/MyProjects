...
namespace TattooYou.Forms
{
    public partial class FormEditService : Form
    {
        ...
        public FormEditService(int id) : this()
        {
            serviceId = id;
            LoadServiceData();
        }
        ...
        private void LoadServiceData()
        {
            ...
            {
                conn.Open();
                string query = "SELECT name, description, price FROM services WHERE id = @id";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            using (var conn = DatabaseHelper.GetConnection())
            {
                ...
                if (serviceId == null)
                {
                    string insert = "INSERT INTO services (name, description, price) VALUES (@name, @description, @price)";
                ...
                {
                    string update = "UPDATE services SET name = @name, description = @description, price = @price WHERE id = @id";
