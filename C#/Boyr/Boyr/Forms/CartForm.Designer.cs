    ...
    partial class CartForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dataGridView.Columns.AddRange(new DataGridViewColumn[] {
                new DataGridViewTextBoxColumn { Name = "ProductId", HeaderText = "ID", Visible = false },
                new DataGridViewTextBoxColumn { Name = "Name", HeaderText = "Изделие", ReadOnly = true },
                new DataGridViewTextBoxColumn { Name = "Metal", HeaderText = "Металл/Проба", ReadOnly = true },
                new DataGridViewTextBoxColumn { Name = "Weight", HeaderText = "Вес, г", ReadOnly = true },
                new DataGridViewTextBoxColumn { Name = "Gemstone", HeaderText = "Камень", ReadOnly = true },
                new DataGridViewTextBoxColumn { Name = "Price", HeaderText = "Цена", ReadOnly = true },
                new DataGridViewTextBoxColumn { Name = "Quantity", HeaderText = "Количество" },
                new DataGridViewTextBoxColumn { Name = "Total", HeaderText = "Сумма", ReadOnly = true }
            });
